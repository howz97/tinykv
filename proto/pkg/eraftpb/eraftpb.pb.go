...
type Message struct {
	...
	CtxNum               uint64      `protobuf:"varint,12,opt,name=ctx_num,json=ctxNum,proto3" json:"ctx_num,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *Message) GetCtxNum() uint64 {
	if m != nil {
		return m.CtxNum
	}
	return 0
...
func (m *Message) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CtxNum != 0 {
		dAtA[i] = 0x60
		i++
		i = encodeVarintEraftpb(dAtA, i, uint64(m.CtxNum))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *Message) Size() (n int) {
	...
	if m.CtxNum != 0 {
		n += 1 + sovEraftpb(uint64(m.CtxNum))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CtxNum", wireType)
			}
			m.CtxNum = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptor_eraftpb_c3e03980156cbb8b = []byte{
	...
	,
}
